// Curated DSL snippets. Surfaced via GET /examples and consumed by the
// web app's "Load example" dropdown. Keep entries short and focused —
// each one should demonstrate a distinct feature of the DSL.
